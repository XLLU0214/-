...
<script type="text/javascript">
	$(function(){
		...
		$("#vcodeImg").click(function(){
			this.src="CpachaServlet?method=loginCpacha&vl=5&fs=28&t="+new Date().getTime();
		});
...
<title>登录|浙江工商大学学生宿舍管理系统</title>
<meta name="keywords" content="浙江工商大学学生宿舍管理系统">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 500px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">浙江工商大学学生宿舍管理系统</h2>
</div>
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="点击图片切换验证码" id="vcodeImg" src="CpachaServlet?method=loginCpacha&vl=5&fs=28"></div>
      </div>
...
<div class="footer">Copyright &nbsp; student @ 谢晓露 </div>
