	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'dormitoryManagerId',title:'所属宿管',width:200, formatter:function(value,rowData,rowIndex){
 		        ...
 		        {field:'location',title:'所属位置',width:200},
	 		]], 
	        toolbar: "#toolbar",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left; margin-left: 10px;">宿管：<input id="search-dormitory-manager" class="easyui-combobox"/></div>
		<div style="float: left; margin-left: 10px;margin-top: 3px;">名称：<input id="search-name" class="easyui-textbox" /></div>
	...
	<div id="addDialog" style="padding: 10px">  
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>所属位置:</td>
	    			<td><input id="add_location" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="location" data-options="required:true, missingMessage:'请填写所属位置'"  /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">
		<form id="editForm" method="post">
	    	...
	    	<table cellpadding="8" >
	    		<tr>
	    			<td>名称:</td>
	    			<td><input id="edit_name" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="name" data-options="required:true, missingMessage:'请填写名称'" /></td>
	    		</tr>
	    		<tr>
	    			<td>所属宿管:</td>
	    		...
	    		<tr>
	    			<td>所属位置:</td>
	    			<td><input id="edit_location" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="location" data-options="required:true, missingMessage:'请填写所属位置'"  /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
